...
const SYSTEM_MESSAGES = {
    ...
    LEVEL_UP: (level)=>`🎉 Congratulations! You've reached level ${level}! New abilities and areas are now available.`,
    WANTED_INCREASE: (level)=>`⚠️ Warning: Your wanted level has increased to ${level}. Corporate security forces are on high alert.`,
    ABILITY_UNLOCK: (ability)=>`🔓 New ability unlocked: ${ability}! Type !abilities to learn more.`,
